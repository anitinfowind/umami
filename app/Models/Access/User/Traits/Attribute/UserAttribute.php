...
trait UserAttribute
{
 ...
 public function getOrderButtonAttribute($class)
  {
          return '<a class="'.$class.'" href="'.route(
                    'admin.access.user.orderhistory',
                    $this
                ).'"><i class="fa fa-lock" data-toggle="tooltip" data-placement="top"></i>Order History</a>';
    }

 public function getWishlistButtonAttribute($class)
  {
          return '<a class="'.$class.'" href="'.route(
                    'admin.access.user.wishlist',
                    $this
                ).'"><i class="fa fa-heart-o" aria-hidden="true"></i>Wish list</a>';
    }
    ...
    public function checkAdmin()
    {
        if ($this->id != 1) {
            return '<div class="btn-group dropup">
                        ...
                        <li>'.$this->getOrderButtonAttribute('').'</li>
                        <li>'.$this->getWishlistButtonAttribute('').'</li>
                        </ul>
                    </div>';
        }
    }
