...
class SocialLoginController extends Controller
{
    ...
    private function getAuthorizationFirst($provider)
    {
        ...
        $scopes = config("services.{$provider}.scopes") ? config("services.{$provider}.scopes") : false;
        $with = config("services.{$provider}.with") ? config("services.{$provider}.with") : false;
        $fields = config("services.{$provider}.fields") ? config("services.{$provider}.fields") : false;
