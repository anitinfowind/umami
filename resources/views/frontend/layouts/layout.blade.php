...
@yield('meta')
@yield('before-styles')
@include('frontend.includes.modified_style')
...
<script src="{{ asset('latest/js/jquery-3.5.1.min.js') }}" type="text/javascript"></script>
<script src="{{ asset('latest/js/bootstrap.min.js') }}"></script>
...
<div id="app"> 
  ...
  @include('frontend.includes.new.nav')
  @yield('content')
  @include('frontend.includes.new.footer')
</div>
@include('includes.partials.ga')
@include('frontend.includes.modified_script')
@yield('after-script')
