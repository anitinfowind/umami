...
<h1 style="display: none;">{{ $segment == 'login' ? 'Login' : '' }}{{ $segment == 'register' ? 'Register' : '' }}</h1>
				...
				<div class="display-section login-section">
					<div class="display-description">
						<ul class="nav nav-tabs nav-justified" role="tablist">
							...
							<li class="nav-item">
								<a class="nav-link @if($segment === 'register') active @endif" data-toggle="tab" href="#Registro">Sign Up</a>
							</li>
						</ul>
                  ...
                  <input type="hidden" name="preview" value="{{isset($_REQUEST['key'])?$_REQUEST['key']:''}}">
								...
								<div class="form-group">
									<div class="col-md-12 text-center">
										<button class="btn btn-lg btn-google google111 btn-block text-uppercase" type="button" onclick="window.location.href='{{ url('login/google') }}';"><i class="fa fa-google
										mr-2"></i>
								...
								<div class="form-group">
									<div class="col-md-12 text-center">
										<button class="btn btn-lg btn-facebook facebook111 btn-block text-uppercase" type="button" onclick="window.location.href='{{ url('login/facebook') }}';"><i class="fa fa-facebook-f
										mr-2"></i> Sign in with Facebook</button>
									</div>
								</div>
							</div>
							<div id="Registro" class="tab-pane @if($segment === 'register') active @endif">
								<h2>Sign Up</h2>
								{{ Form::open([
                   ...
                   {{ Form::hidden(
                          ...
                          [
                            'class' => 'form-control',
									...
									<div class="form-group">
										<div class="col-md-12 text-center">
											<button
													id="submit-contact"
													class="catg-btn"
													onclick='formData("register_form", "Registration", "You have successfully registered", "{{ url(isset($_REQUEST['key']) ? str_replace('\\', '/', $_REQUEST['key']) : 'login') }}")'
													type="button">
												{{ trans('Sign up') }}
											</button>
										</div>
								...
								<div class="form-group">
									<div class="col-md-12 text-center">
										<button class="btn btn-lg btn-google btn-block text-uppercase google111" type="button" onclick="window.location.href='{{ url('login/google') }}';"><i class="fa fa-google
										mr-2"></i> Sign in with Google</button>
									</div>
								</div>
								<div class="form-group">
									<div class="col-md-12 text-center">
										<button class="btn btn-lg btn-facebook btn-block text-uppercase facebook111" type="button" onclick="window.location.href='{{ url('login/facebook') }}';"><i class="fa fa-facebook-f
										mr-2"></i> Sign in with Facebook</button>
									</div>
								</div>
							</div>
