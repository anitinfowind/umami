...
<head>
  ...
  <script src="{{ asset('js/index.js') }}"></script>
    <link rel="stylesheet" type="text/css" href="https://stripe.dev/elements-examples/css/example3.css" data-rel-css="" />
</head>
...
<body>
  ...
  <script src="https://stripe.dev/elements-examples/js/example3.js" data-rel-js></script>
