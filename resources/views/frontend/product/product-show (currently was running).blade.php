  ...
  <div class="container">
    ...
    <div class="row">
        ...
        <div class="product-wrapbox"> @if($categorys->isNotEmpty())
          <div class="catagory-filter m_t20">
            ...
            <div class="filter-catagory catagory-des">
              <ul>
                <li class="btn filter-cat-li active" data-filter="*">All</li>
                @foreach($categorys as $category)
                <li class="btn filter-cat-li" data-filter=".category_{{$category->id}}"><span>{{ $category->name() }}</span></li>
                @endforeach
              </ul>
            </div>
          </div>
          ...
          <div class="catagory-filter m_t20">
            ...
            <div class="filter-catagory catagory-des">
              <ul>
                ...
                <li class="btn filter-cat-li" data-filter=".diet_{{$diet->id}}"><span>{{ $diet->name() }}</span></li>
                @endforeach
              </ul>
            </div>
          </div>
      ...
      <div class="col-lg-9 col-md-9 col-sm-6 col-12"> @if($products->isNotEmpty())
        <div class="catagory-filte-box product-section p-0 mealfood" id="product-item-section"> @foreach($products as $product)
...
function showProducts(minPrice, maxPrice) {
  /*$("#product-item-section .product_items").hide().filter(function() {
...
$('.catagory-des ul li').click(function() {
    $('.catagory-des ul li').removeClass('active');
 ...
 $.ajax({
  ...
  <?php if(isset($_GET['cat'])) { ?>
    $(window).on('load', function(){
      $('.catagory-filter li[data-filter=".category_{{ $_GET['cat'] }}"]').trigger('click');
    });
  <?php } ?>
