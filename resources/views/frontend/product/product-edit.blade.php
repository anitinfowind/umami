                         ...
                         <!--  <div class="form-group col-md-12">
                          ...
                          <div class="form-group col-md-12">
                            <label class = 'control-label'>Instruction Image<span class=""></span></label>
                             ...
                             @if(isset($productDetail->instruction_img) && !empty($productDetail->instruction_img) && File::exists(PRODUCT_ROOT_PATH.$productDetail->instruction_img))

                                  <?php $instimg = PRODUCT_URL.$productDetail->instruction_img; ?>
                                   <input type="hidden" name="oldinstruction_img" value="{{$productDetail->instruction_img}}">
                                 <img class="imageThumb" src="{{ $instimg }}">
                                  @endif
                             </div>
                          </div>
