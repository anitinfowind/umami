    ...
    <div class="row">
      ...
      <div class="col-lg-6 col-md-6 col-sm-6 col-12">
        <div class="mealkit-deatils-sec">
          <div class="mealkit-deatils-box">
            ...
            <p>From<a href="{{ url('restaurant-detail/'.$restaurant->slug)}}">{!!
              restaurantName($details->restaurant_id) !!}</a>
              <?php
        ...
        <div class="meal-price w-100 srv-text">
            ...
            <h2>$<span class="base_price" data-price="{{ $price }}">{{ $price }}</span> <span data-serving="{{ $serving_for }}" data-per-person="{{ $per_price }}" class="per_person">(${{$per_price}}/{{ $serving_for }})</span></h2>

            <!-- <h2>$<span class="base_price" data-price="{{ $price }}">{{ $per_price }}/{{ $serving_for }}</span> <span style="display: none;" data-serving="{{ $serving_for }}" data-per-person="{{ $per_price }}" class="per_person">(${{$per_price}}/{{ $serving_for }})</span></h2> -->
            @if($details->discount()) <span class="ofr-price pl-1"> ${{ $details->price() }} </span> <span class="discount pl-1">{{ $details->discount() }}%</span> 
            @endif 
        </div>
                ...
                <label>{{ $key }}</label>
                    <select class="addon_price">
                        ...
                        @foreach($value as $index => $row)
                            <option value="{{ $row['price'] }}">{{ $row['option_name'] }}</option>
                        @endforeach   
                    </select>
            </div>
            @endforeach
      ...
      <div class="col-12">
        <div class="mealkit-food-tabs">
          <div class="accoutTabs">
            ...
            <ul id="tabs" class="nav nav-tabs nav-justified" role="tablist">
                <li class="nav-item">
                    <a id="tab-A" href="#pane-A" class="nav-link {{ $tabact == 'A' ? 'active' : '' }}" data-toggle="tab" role="tab">Ingredients</a>
                </li>
                <li class="nav-item">
                    <a id="tab-B" href="#pane-B" class="nav-link {{ $tabact == 'B' ? 'active' : '' }}" data-toggle="tab" role="tab">Instruction</a>
                </li>
                <li class="nav-item">
                    <a id="tab-C" href="#pane-C" class="nav-link {{ $tabact == 'C' ? 'active' : '' }}" data-toggle="tab" role="tab">How To Store Food</a>
                </li>
                <li class="nav-item">
                    <a id="tab-D" href="#pane-D" class="nav-link {{ $tabact == 'D' ? 'active' : '' }}" data-toggle="tab" role="tab">Reviews</a>
                </li>
            </ul>
          </div>
          <div id="content" class="tab-content" role="tablist">
            <div id="pane-A" class="card tab-pane fade {{ $tabact == 'A' ? 'active show' : '' }}" role="tabpanel" aria-labelledby="tab-A">
              <div class="card-header" role="tab" id="heading-A">
                  <h5 class="mb-0">
                      <a class="{{ $tabact == 'A' ? '' : 'collapsed' }}" data-toggle="collapse" href="#collapse-A" aria-expanded="true" aria-controls="collapse-A">Ingredients<i class="fa fa-angle-down"></i></a>
                  </h5>
              </div>
              <div id="collapse-A" class="collapse {{ $tabact == 'A' ? 'show' : '' }}" data-parent="#content" role="tabpanel" aria-labelledby="heading-A">
                <div class="card-body">
            ...
            <div id="pane-B" class="card tab-pane fade {{ $tabact == 'B' ? 'active show' : '' }}" role="tabpanel" aria-labelledby="tab-B">
              <div class="card-header" role="tab" id="heading-B">
                <h5 class="mb-0">
                    <a class="{{ $tabact == 'B' ? '' : 'collapsed' }}" data-toggle="collapse" href="#collapse-B" aria-expanded="false" aria-controls="collapse-B">Instruction<i class="fa fa-angle-down"></i></a>
                </h5>
              </div>
              <div id="collapse-B" class="collapse {{ $tabact == 'B' ? 'show' : '' }}" data-parent="#content" role="tabpanel" aria-labelledby="heading-B">
                <div class="card-body">
            ...
            <div id="pane-C" class="card tab-pane fade {{ $tabact == 'C' ? 'active show' : '' }}" role="tabpanel" aria-labelledby="tab-C">
              <div class="card-header" role="tab" id="heading-C">
                <h5 class="mb-0">
                    <a class="{{ $tabact == 'C' ? '' : 'collapsed' }}" data-toggle="collapse" href="#collapse-C" aria-expanded="false" aria-controls="collapse-C">How To Store Food<i class="fa fa-angle-down"></i></a>
                </h5>
              </div>
              <div id="collapse-C" class="collapse {{ $tabact == 'C' ? 'show' : '' }}" data-parent="#content" role="tabpanel" aria-labelledby="heading-C">
                <div class="card-body">
            ...
            <div id="pane-D" class="card tab-pane fade {{ $tabact == 'D' ? 'active show' : '' }}" role="tabpanel" aria-labelledby="tab-D">
              <div class="card-header" role="tab" id="heading-D">
                <h5 class="mb-0">
                    <a class="{{ $tabact == 'D' ? '' : 'collapsed' }}" data-toggle="collapse" href="#collapse-D" aria-expanded="false" aria-controls="collapse-D">Reviews<i class="fa fa-angle-down"></i></a>
                </h5>
              </div>
              <div id="collapse-D" class="collapse {{ $tabact == 'D' ? 'show' : '' }}" data-parent="#content" role="tabpanel" aria-labelledby="heading-D">
                <div class="card-body">
                  <div class="food-inner-details">
                    ...
                    <div class="review_form_block mt-4">
                      ...
                      foreach ($reviews_for as $key => $value) {
                        ...
                        <div class="revopt col-lg-3 col-md-6 col-sm-6 col-6 mb-2">
                          <span>{{ $value['title'] }}:</span>
                          <label class="ratingColor" opt_key="rate_{{ $value['key'] }}" opt_rate="5">
          ...
          <div class="food-time-rvw-box">
            ...
            <div class="price-box d-flex align-items-center justify-content-between">
              ...
              <div class="price-box-rgt">
                <p>Price ${{$recommend->price()}} <span class="per_person">(${{number_format($recommend->price/$recommend->quantity, 2)}}/{{ $rec_serving_for }})</span></p>
              </div>
            </div>
          </div>
        </div>
