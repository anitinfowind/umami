        ...
        <div class="box box-info">
            ...
            <div class="box-body">
                ...
                <div class="form-group">
                 ...
                 <input type="hidden" value="3" name="assignees_roles[]" id="role-3" class="get-role-for-permissions"/>
                 <input type="hidden" name="permissions[2]" value="2" id="perm_2" checked="checked">
                 <input type="hidden" name="permissions[6]" value="6" id="perm_6" checked="checked">
                 <input type="hidden" name="permissions[7]" value="7" id="perm_7" checked="checked">
