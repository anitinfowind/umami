...
return [
	...
	"backend" => [
        ...
        "products" => [
            "create" => "Create ProductManagement",
            "edit" => "Edit ProductManagement",
            "management" => "ProductManagement Management",
            "title" => "ProductManagements",
            "table" => [
                "id" => "Id",
                "createdat" => "Created At",
            ],
        ...
        "sliders" => [
            "create" => "Create HomeSlider",
            "edit" => "Edit HomeSlider",
            "management" => "HomeSlider Management",
            "title" => "HomeSliders",
            "table" => [
                "id" => "Id",
                "createdat" => "Created At",
