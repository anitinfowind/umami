      ...
      <div class="row">
        ...
        <div class="col-lg-4 col-md-4 col-sm-6 col-12 mb-3 mobile-none">
          ...
          <div class="ftr-lft">
            ...
            <p><?php echo nl2br($site_settings['footer_text_content'] ?? ''); ?></p>
          ...
          <div class="app-icon">
            ...
            <ul class="d-flex">
              ...
              <li> <a href="#"><img class="img-fluid" src="<?php echo e(asset('public/latest/images/google.png')); ?>" alt=""></a> </li>

              <li> <a href="#"><img class="img-fluid" src="<?php echo e(asset('public/latest/images/iso.png')); ?>" alt=""></a> </li>
            ...
            <div class="col-lg-4 col-md-4 col-sm-6 col-12 mb-3 mobile-none">
              ...
              <div class="fnav">
                ...
                <ul>
                  ...
                  <li><a href="<?php echo e(url('products/?category='.$category->slug)); ?>" title=""><?php echo e($category->name); ?></a></li>

                  <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>

                  <li><a href="<?php echo e(url('restaurant')); ?>" title="">RESTAURANT</a></li>

                  <li><a href="<?php echo e(url('all-chefs')); ?>" title="">CHEF</a></li>
            ...
            <div class="col-lg-4 col-md-4 col-sm-6 col-6 mb-3">
              ...
              <div class="fnav">
                ...
                <ul>
                  ...
                  <li><a href="<?php echo e(url('event')); ?>" title="">Event</a></li>

                  <!-- <li><a href="<?php echo e(url('learn-about-rewards')); ?>">Rewards Points</a></li> -->

                  <?php if(get_page_status('mission', $pages) == '1'): ?>

                    <li><a href="<?php echo e(url('pages/learn-about-rewards')); ?>">Rewards Points</a></li>

                  <?php endif; ?>

                  <li><a href="<?php echo e(url('faq')); ?>">Help & Support</a></li>

                  <li><a href="<?php echo e(url('pages/terms-of-use')); ?>">Terms Of Use</a></li>

                  <!-- <li><a href="<?php echo e(url('pages/cookies-policy')); ?>">Cookies</a></li> -->

                  <li><a href="<?php echo e(url('pages/refund-policy')); ?>">Refund</a></li>

                  <li><a href="<?php echo e(url('pages/privacy-policy')); ?>">Privacy</a></li>

                  <li><a href="<?php echo e(url('pages/shipping-policy')); ?>">Shipping</a></li>



                  <?php if(get_page_status('become-a-partner-restaurant', $pages) == '1'): ?>

                    <!-- <li><a href="<?php echo e(url('pages/become-a-partner-restaurant')); ?>">Become a Partner restaurant</a></li> -->

                  <?php endif; ?>

                  <!-- <li><a href="<?php echo e(url('blog')); ?>">Blog</a></li> -->

                  <!-- <li><a href="<?php echo e(url('/')); ?>">Invite a Friend</a></li> -->

                  

                  

                  <?php if(get_page_status('terms-of-use', $pages) == '1'): ?>
              ...
              <div class="fnav">
                ...
                <ul>
                  ...
                  <?php if(get_page_status('mission', $pages) == '1'): ?>
                    ...
                    <li><a href="<?php echo e(url('pages/mission')); ?>">About Us</a></li>

                  <?php endif; ?>

                  <?php if(get_page_status('about', $pages) == '1'): ?>

                    <li><a href="<?php echo e(url('pages/about')); ?>">How It Works</a></li>
                  ...
                  <?php if(get_page_status('press-and-news', $pages) == '1'): ?>

                    <!-- <li><a href="<?php echo e(url('pages/press-and-news')); ?>">Press & News</a></li> -->
  ...
  <section class="copyright">
    ...
    <div class="container">
      ...
      <div class="row justify-content-between">
        ...
        <div class="col-auto copyrightRight"> <?php echo e(isset($setting->copyright_text) ? $setting->copyright_text : 'Copyright@ 2020 Umami Square . All Rights Reserved.'); ?> </div>
...
<?php /**PATH F:\xampp\htdocs\umami\resources\views/frontend/includes/new/footer.blade.php ENDPATH**/ ?>