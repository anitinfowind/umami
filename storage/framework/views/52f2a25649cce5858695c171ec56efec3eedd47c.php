...
<?php echo $__env->make('frontend.includes.new.slider', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
...
<input type="hidden" name="isuservalid" value="<?php echo e(auth()->user()->isUser()); ?>" class="userCheckAuth">
<?php endif; ?>
          ...
          foreach ($testimonials as $key => $value) {
            ...
            <!--  <div class="item w-100"> 
              <div class="testi-user d-flex align-items-center">
                ...
                <div class="user-name">
                  <h4><?php echo e($value->first_name . ' ' . $value->last_name); ?></h4>
            ...
            <div class="item w-100">
              <div class="testi-user d-flex align-items-center"> 
                <div class="user-pic">
                  <!-- <img src="<?php echo e($img); ?>" alt=""> -->
                  <img src="<?php echo e($img); ?>" alt="user-image">
                </div> 
                <div class="user-name">
                  <h4><?php echo e($value->first_name . ' ' . $value->last_name); ?></h4>
                  <p><?php echo e($value->title); ?></p> 
              ...
              <div class="back-img"> 
                ...
                <?php if($ext=='jpeg'||$ext=='jpg'||$ext=='png' ||$ext=='gif'||$ext=='webp'): ?> 
                  ...
                  <?php endif; ?>
                  <img class="resto product_list" src="<?php echo e($post_image); ?>" alt="<?php echo e($value->id); ?>">
                  <?php elseif($ext != ''): ?>
                  <?php $post_image = url('public/uploads/testimonial/post_image/'.$value->post_image);
                      ?>
                  <div class="video-sec">
                    <video width="" height="" muted loop  controls poster="<?php echo e(url('thimbnailimage.png')); ?>"> 
                      <source src="<?php echo e($post_image); ?>" type="video/mp4"> 
                    </video>
                  </div> 
                <?php endif; ?>
              </div>
...
<?php $__currentLoopData = $categoryproduct; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $p=>$pcategory): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>

<section class="noodles-items-sec">

  <div class="container">

    <div class="row justify-content-between align-items-center"> <?php if($pcategory['product']->isNotEmpty()): ?>

      <div class="col-auto">

        <div class="sec-head">

          <h4><?php echo e($pcategory['category']); ?></h4>
      ...
      <?php if($pcategory['product']->isNotEmpty()): ?>

      <!-- <div class="col-auto forDesktop">

        <div class="view-all-btn"> <a href="<?php echo e(url('products?cat='.$pcategory['category_id'])); ?>">view all</a> </div>
    ...
    <div class="product-section d-flex" id="category_<?php echo e($pcategory['slug']); ?>">

      <?php $i=0;foreach($pcategory['product'] as $product){?>

      <?php if(isset($product->singleProductImage->image) && !empty($product->singleProductImage->image)): ?>
    ...
    $serving_for = (!empty($product->serving_for)) ? $product->serving_for : 'people';
      ...
      <div class="custome-col-3 product_item" data-id="<?php echo e($product->id); ?>">
        ...
        <div class="food-box relative">
          ...
          <div class="food-pic relative"> 
            ...
            <span class="heart-icon"><a href="javascript:void(0)" class="unfavourite_token fav_<?php echo e($product->id); ?>" data-fav-id="<?php echo e($product->id); ?>"><i class="dataamount food_tab_<?php echo e($product->id); ?> far fa-heart" id="fav_<?php echo e($product->id); ?>"></i></a></span>

            <?php }else{ ?>

            <span class="heart-icon"><a href="javascript:void(0)" class="unfavourite_token fav_<?php echo e($product->id); ?>" data-fav-id="<?php echo e($product->id); ?>"><i class="dataamount food_tab_<?php echo e($product->id); ?> fa fa-heart-o" id="fav_<?php echo e($product->id); ?>"></i></a></span>

            <?php } ?>

            <?php } ?>

            <?php else: ?> <span class="heart-icon"><a href="<?php echo e(url('/login')); ?>" class="unfavourite_token fav_<?php echo e($product->id); ?>"  data-fav-id="<?php echo e($product->id); ?>" data-fav-value="12"><i class="dataamount food_tab_<?php echo e($product->id); ?> fa fa-heart-o" id="fav_<?php echo e($product->id); ?>"></i></a></span> <?php endif; ?> <span class="discount-percent">free shipping</span> <span class="trending"><?php echo e($pcategory['category']); ?></span> </div>

          <div class="food-name d-flex align-items-center">

            <div class="foodname-lft">
          
              <h4><a href="<?php echo e(url('product-detail/'.$product->slug)); ?>"><?php echo e($product->title); ?></a></h4>
              ...
              <div class="foodname-rgt d-flex">
                ...
                <a href="<?php echo e(url('product-detail/' . $product->slug . '?tab=D#heading-D')); ?>" class="d-flex">
              ...
              <div class="price-box-rgt">
                <!--Price $<?=$price;?> -->
                <p><span class="per_person">$<?php echo e(number_format($price/$product->quantity, 2)); ?>/<?php echo e($serving_for); ?></span>
              ...
              <!--<h4><?php echo e(Str::limit($product->title,20)); ?></h4>

              <p><?php echo e(Str::limit($restaurantname,20)); ?></p>--> 
         ...
         <!--  <div class="food-time-rvw-box">
            ...
            <div class="food-time d-flex align-items-center justify-content-between">
              ...
              <p><?php echo e(Str::limit($product->description,82)); ?></p>
    ...
    <?php if(count($pcategory['product'])>5): ?> 

    <!--<div class="row">

      <div class="col-12">

        <div class="load-more-btn"> <a href="javascript:;" class="load_more_btn" data-categoty="<?php echo e($pcategory['slug']); ?>" data-category_id="<?php echo e($pcategory['category_id']); ?>" data-pg="1">load more</a> </div>
    ...
    <?php if($pcategory['product']->isNotEmpty()): ?>
      ...
      <div class="text-center mt-3"><div class="view-all-btn"> <a href="<?php echo e(url('products?cat='.$pcategory['category_id'])); ?>">view all</a> </div></div>
...
<section  class="paralaxBg text-center bg-cover parallax relative"  id="parallax-5" data-image-src="<?php echo e(BANNER_URL.$unlimitedfree->image); ?>" data-height="350px">

  <div class="container">

    <div class="paralaxSlogan">

      <h2><?php echo e(isset($unlimitedfree->title)?$unlimitedfree->title:'Unlimited Free Delivery with'); ?></h2>

      <a href="<?php echo e(isset($unlimitedfree->button_url)?$unlimitedfree->button_url: url('products')); ?>">order now</a> </div>
...
<!-- <section>
  <div class="video-section">
   <div class="video-section-inner"> -->
    ...
    <?php else: ?>
    <!-- <video  loop="" muted="" playsinline="" autoplay="">
      <source src="<?php echo e(url('public/uploads/product/IMG_2400.mov')); ?>" type="video/mp4"> -->
...
<section class="restaurants-sec">
  ...
  <div class="container">
    ...
    <div class="row justify-content-between align-items-center">
      ...
      <?php if(count($restaurantList)>5): ?>

      <!-- <div class="col-auto forDesktop">

        <div class="view-all-btn"> <a href="<?php echo e(url('restaurant')); ?>">view all</a> </div>

      </div> -->

      <?php endif; ?> </div>

    <?php if($restaurantList->isNotEmpty()): ?>
    ...
    <div class="product-section d-flex" id="restaurant_section">
      ...
      <?php if(isset($restaurant->restaurantSingleImage->image) && !empty($restaurant->restaurantSingleImage->image)): ?>
      ...
      <div class="custome-col-3 product_item">
        ...
        <div class="food-box relative">
          ...
          <div class="food-pic relative">
            ...
            <!-- <a href="<?php echo e(url('restaurant-detail/'.($restaurant->slug ?? ''))); ?>"><img src="<?php echo e(WEBSITE_IMG_URL.'blank2.jpg'); ?>" data-src="<?php echo e($restaurant_image); ?>" alt="<?php echo e($restaurant->name); ?>" class="lazy" /></a> -->
          ...
          <div class="food-name d-flex align-items-center justify-content-between">
            ...
            <div class="foodname-lft">
              ...
              <h4><a href111="<?php echo e(url('user-detail/'.($restaurant->userSlug->slug ?? ''))); ?>" href="<?php echo e(url('restaurant-detail/'.($restaurant->slug ?? ''))); ?>"><?php echo $restaurant->name; ?></a></h4>

              <p><i class="fas fa-map-marker-alt"></i><?php echo e(isset($restaurant->restaurantLocation->state)?$restaurant->restaurantLocation->state:''); ?>
  ...
  <div class="container">
    ...
    <div class="row justify-content-between align-items-center">
      ...
      <!-- <div class="col-auto forDesktop">
        ...
        <div class="view-all-btn"> <a href="<?php echo e(url('all-chefs')); ?>">view all</a> </div>

      </div> -->

      <?php endif; ?> </div>

    <div class="product-section d-flex" id="recommended_section"> <?php if($chefs->isNotEmpty()): ?>
      ...
      <div class="custome-col-3">
        ...
        <div class="food-box relative">
          ...
          <div class="food-pic relative"> <a href111="<?php echo e(url('user-detail/'.$chef->slug)); ?>" href="<?php echo e(url('restaurant-detail/'.($chef->getRestautent->slug ?? ''))); ?>"><img src="<?php echo e(WEBSITE_IMG_URL.'blank2.jpg'); ?>" data-src="<?php echo e(url('public/uploads/chef/'.$chef_image)); ?>" class="lazy" alt=""></a> </div>

          <div class="food-name d-flex align-items-center justify-content-between">

            <div class="foodname-lft">

              <h4><a href="<?php echo e(url('restaurant-detail/'.($chef->getRestautent->slug ?? ''))); ?>"><?php echo e($chef->name); ?></a></h4>

              <p><i class="fas fa-map-marker-alt"></i><?php echo e($chef->getRestautent->restaurantLocation->city ?? ''); ?>, <?php echo e($chef->getRestautent->restaurantLocation->country ?? ''); ?></p> 

              <p class="name-edit"><a href="<?php echo e(url('restaurant-detail/'.($chef->getRestautent->slug ?? ''))); ?>"><i class="fas fa-edit"></i><?php echo $chef->getRestautent->name ?? ''; ?></a></p>
          ...
          <div class="food-time-rvw-box"> 
            ...
            <p class="box-ftr-text"><?php echo Str::limit($chef->description, 82); ?></p>
...
<section class="recommended-sec">
  ...
  <div class="container">
    ...
    <div class="product-section d-flex" id="recommended_section"> <?php if($productsrecomm->isNotEmpty()): ?>
          ...
          <div class="food-time-rvw-box">
            ...
            <div class="price-box d-flex align-items-center justify-content-between">
              ...
              <div class="price-box-rgt">
                ...
                <p>Price $<?php echo e($recommend->price()); ?></p>
...
<?php echo $__env->make('frontend.layouts.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH F:\xampp\htdocs\umami\resources\views/frontend/index.blade.php ENDPATH**/ ?>