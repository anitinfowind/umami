<script src="<?php echo e(asset('latest/js/owl.carousel.min.js')); ?>"></script>
<script src="<?php echo e(asset('latest/js/owl.carousel2.thumbs.js')); ?>"></script>
<script defer src="<?php echo e(asset('latest/js/custom.js?t=' . time())); ?>"></script>
<script src="<?php echo e(asset('latest/js/date-picker-js.js')); ?>"></script>
<script src="<?php echo e(asset('latest/js/paralax.js')); ?>"></script>
<script src="<?php echo e(asset('latest/js/slick.js')); ?>"></script>
<script src="<?php echo e(asset('latest/js/slick.min.js')); ?>"></script>
<script src="<?php echo e(asset('latest/js/script.js')); ?>"></script>
<script src="<?php echo e(asset('latest/js/wow.min.js')); ?>"></script>
<script src="<?php echo e(asset('js/popper.min.js')); ?>"></script>
<script src="<?php echo e(asset('js/custom.js')); ?>"></script>
<script src="<?php echo e(asset('js/jquery.form.js')); ?>"></script>
<script src="<?php echo e(asset('js/pnotify.core.js')); ?>"></script>
<script src="<?php echo e(asset('js/bootbox.js')); ?>"></script>
<script src="<?php echo e(asset('js/freshslider.1.0.js')); ?>"></script>
<script src="<?php echo e(asset('js/jquery-ui.js')); ?>"></script>
<script src="<?php echo e(asset('latest/js/jquery.ui.touch-punch.min.js')); ?>"></script>
<script src="<?php echo e(asset('js/jquery.oauthpopup.js')); ?>"></script>
<script src="<?php echo e(asset('js/jquery-eu-cookie-law-popup.js')); ?>"></script>
...
<script src="<?php echo e(asset('latest/js/sudipta.js?t=' . time())); ?>"></script>
...
<script>
  ...
  $(document).ready(function() {
    initialize();
      <?php if(session()->has('account-verification')): ?>
        <?php
        $session = session()->get('account-verification');
        $title = $session['title'];
        $msg = $session['msg'];
        ?>
        notice("<?php echo e($title); ?>", "<?php echo e($msg); ?>", 'success');

        <?php echo e(session()->forget('account-verification')); ?>

      <?php endif; ?>

      <?php if(session()->has('send-verification-link')): ?>
        <?php
        ...
        <?php echo e(session()->forget('send-verification-link')); ?>
      ...
      <?php if(session()->has('reset-password')): ?>
        ...
        <?php echo e(session()->forget('reset-password')); ?>
      ...
      <?php if(session()->has('errors')): ?>
        ...
        $msg = $session['msg'];
        ?>
        notice("<?php echo e($title); ?>", "<?php echo e($msg); ?>", 'error');

        <?php echo e(session()->forget('errors')); ?>

      <?php endif; ?>

      <?php if(session()->has('update-profile')): ?>
        <?php
        ...
        <?php echo e(session()->forget('update-profile')); ?>
      ...
      <?php if(session()->has('address')): ?>
        ...
        <?php echo e(session()->forget('address')); ?>

      <?php endif; ?>

      <?php if(session()->has('restaurant')): ?>
        <?php
        ...
        <?php echo e(session()->forget('restaurant')); ?>
      ...
      <?php if(session()->has('product')): ?>
        ...
        <?php echo e(session()->forget('product')); ?>

      <?php endif; ?>

      <?php if(session()->has('product_update')): ?>
        <?php
        ...
        <?php echo e(session()->forget('product_update')); ?>
      ...
      <?php if(session()->has('branch')): ?>
        ...
        <?php echo e(session()->forget('branch')); ?>

      <?php endif; ?>

      <?php if(session()->has('chefs')): ?>
        <?php
        ...
        <?php echo e(session()->forget('chefs')); ?>

      <?php endif; ?>

      <?php if(session()->has('chefs-update')): ?>
        <?php
        ...
        <?php echo e(session()->forget('chefs-update')); ?>

      <?php endif; ?>
      <?php if(session()->has('chefs-delete')): ?>
        <?php
        ...
        <?php echo e(session()->forget('chefs-delete')); ?>
     ...
     <?php if(session()->has('coupon')): ?>
      ...
      <?php echo e(session()->forget('coupon')); ?>
	...
	<?php if(session()->has('order')): ?>
      ...
      <?php echo e(session()->forget('order')); ?>
    ...
    <?php if(session()->has('rating')): ?>
      ...
      <?php echo e(session()->forget('rating')); ?>
  ...
  $('.emailcheck').click(function() {
     bootbox.confirm("Are you sure? You want to this status change",
          function(result) {
            if(result){
              ...
              $.ajax({
                ...
                url: "<?php echo e(url('email-status')); ?>",
                data: {'status' : status},
                method: 'POST',
                beforeSend: function () {
                  $("#overlay").show();
         ...
         $('.facebook').click(function(e){
            jQuery.oauthpopup({
                path: "<?php echo URL::to('login/facebook'); ?>",
                width:900,
                height:500,
                callback: function(){
        ...
        $('.google').click(function(e){
            jQuery.oauthpopup({
                path: "<?php echo URL::to('login/google'); ?>",
                width:900,
                height:500,
                callback: function(){
                    window.location.href= "<?php echo URL::to('dashboard'); ?>";
  ...
  $('#state').change(function(){
    ...
    if (countryId !== '') {
      ...
      $.ajax({
        method: "GET",
        url: "<?php echo e(url('restaurant/restaurant-state')); ?>",
        data: {'country_id': countryId},
        success: function (data) {
          $('.state').html(data);
        },
        complete: function () {
          $('#resstate').change(function () {
            ...
            $.ajax({
              method: "GET",
              url: "<?php echo e(url('restaurant/restaurant-city')); ?>",
              data: {'state_id': stateId},
              success: function (data) {
                $('.city').html(data);
              },
  ...
  function subscribe()
  {
      ...
      bootbox.confirm("Are you sure? You want to delete this element",
        function(result) {
          if (result) {
            $.ajax({
              headers: { 'X-CSRF-TOKEN' : $('meta[name="csrf-token"]').attr('content') },
              url: "<?php echo e(url('remove-address')); ?>",
              type: 'post',
      ...
      bootbox.confirm(confirmMessage,
        function(result) {
          if(result) {
            $.ajax({
              headers: { 'X-CSRF-TOKEN' : $('meta[name="csrf-token"]').attr('content') },
              url: "<?php echo e(url('primary-address')); ?>",
              type: 'post',
      ...
      bootbox.confirm("Are you sure? You want to delete this comment",
        function(result) {
          if(result) {
            $.ajax({
              headers: { 'X-CSRF-TOKEN' : $('meta[name="csrf-token"]').attr('content') },
              url: "<?php echo e(url('remove-comment')); ?>",
              type: 'post',
     ...
     */
     function removeImage(imageId)
     {
      $.ajax({
        headers: { 'X-CSRF-TOKEN' : $('meta[name="csrf-token"]').attr('content') },
        url: "<?php echo e(url('restaurant/remove-image')); ?>",
        type: 'post',
     ...
     function backgroundImage(imageId)
     {
      $.ajax({
        headers: { 'X-CSRF-TOKEN' : $('meta[name="csrf-token"]').attr('content') },
        url: "<?php echo e(url('restaurant/remove-backgroundimage')); ?>",
        type: 'post',
        data: { 'image_id' : imageId },
        beforeSend: function() {
          $("#overlay").show();
     ...
     */
     function productRemoveImage(imageId)
     {
      $.ajax({
        headers: { 'X-CSRF-TOKEN' : $('meta[name="csrf-token"]').attr('content') },
        url: "<?php echo e(url('product/remove-image')); ?>",
        type: 'post',
        data: { 'image_id' : imageId },
        beforeSend: function() {
          $("#overlay").show();
      ...
      bootbox.confirm("Are you sure? You want to delete this favorite",
        function(result) {
          if(result) {
            $.ajax({
              headers: { 'X-CSRF-TOKEN' : $('meta[name="csrf-token"]').attr('content') },
              url: "<?php echo e(url('remove-favorite')); ?>",
       ...
       bootbox.confirm("Are you sure? You want to delete this coupon",
         function(result) {
           if(result){
             $.ajax({
               headers: { 'X-CSRF-TOKEN' : $('meta[name="csrf-token"]').attr('content') },
               url: "<?php echo e(url('delete-coupon')); ?>",
      ...
      bootbox.confirm("Are you sure? You want to delete this branch",
        function(result) {
          if(result){
            $.ajax({
              headers: { 'X-CSRF-TOKEN' : $('meta[name="csrf-token"]').attr('content') },
              url: "<?php echo e(url('branch/delete-branch')); ?>",
              data: {'user_id' : userId},
              method: 'POST',
			  beforeSend: function () {
				$("#overlay").show();
		...
		bootbox.confirm("Are you sure? you want to be delete this item",
			function(result) {
				if(result){
					$.ajax({
						headers: { 'X-CSRF-TOKEN' : $('meta[name="csrf-token"]').attr('content') },
						url: "<?php echo e(url('delete-cart-product')); ?>",
						...
						success: function(data) {
							...
							if (data.success == true) {
								...
								if (data.lastRecord) {
									$('.record').html('<img src="<?php echo e(WEBSITE_IMG_URL.'cart.jpg'); ?>">');
								}
								notice('Product','Product has been successfully deleted.','success');
							}
						}
		...
		bootbox.confirm("Are you sure? You want to be " +status.toLowerCase()+ " this order.",
			function(result) {
				if(result){
					$.ajax({
						headers: { 'X-CSRF-TOKEN' : $('meta[name="csrf-token"]').attr('content') },
						url: "<?php echo e(url('order-status')); ?>",
...
</script><?php /**PATH F:\xampp\htdocs\umami\resources\views/frontend/includes/modified_script.blade.php ENDPATH**/ ?>